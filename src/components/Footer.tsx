    ...
    <footer className="bg-[#FFFFFF] border-t border-[var(--c-ink)]/15 py-16 lg:py-20 text-[var(--c-ink)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-8 text-center">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2 font-mono-code text-xs text-[var(--c-ink)]/70">
          <Link to="/projects" className="hover:text-[var(--c-ink)] transition-colors">Projects</Link>
          <Link to="/about" className="hover:text-[var(--c-ink)] transition-colors">About</Link>
          <Link to="/skills" className="hover:text-[var(--c-ink)] transition-colors">Skills</Link>
          <Link to="/contact" className="hover:text-[var(--c-ink)] transition-colors">Contact</Link>
        </nav>
