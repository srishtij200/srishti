    ...
    <section className='w-full bg-[var(--c-warm)]'>
      ...
      >
        ...
        <div
          ...
          style={{ top: '29%', left: '20%', width: '10%', opacity: 0.9 }}
        />
        <div
          className='absolute h-px bg-[var(--c-highlight)]'
          style={{ top: '29%', left: '70%', width: '10%', opacity: 0.9 }}
        />

        {/* Small dark purple sparkle — top-center above name */}
        <SparkleStar size='1.15cqw' color='var(--c-highlight)' style={{ left: '49.4%', top: '24.6%' }} />
