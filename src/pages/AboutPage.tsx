      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between font-mono-code text-xs text-[#182018]/50 pb-4 border-b border-[#182018]/10 mb-12">
          <div className="flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-[#182018] font-semibold">ABOUT ME</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="font-serif-display text-4xl sm:text-6xl text-[#182018] leading-[1.05] tracking-tight">
              {student.degree}
            </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between p-8 bg-[#FFFFFF] border-[1.5px] border-[#182018] rounded-2xl gap-4">
          <div>
            <div className="font-mono-code text-xs uppercase text-[#182018]/60">NEXT IN PORTFOLIO</div>
            <div className="font-serif-display text-2xl text-[#182018]">Explore Aadiya Jewels Internship</div>
          </div>
          <Link
